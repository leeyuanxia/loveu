...
public class CalendarReminderUtils {
    ...
    private static String CALENDARS_NAME = "loveu";
    private static String CALENDARS_ACCOUNT_NAME = "loveu@zcgz.com";
    private static String CALENDARS_ACCOUNT_TYPE = "com.zcgc.loveu";
    private static String CALENDARS_DISPLAY_NAME = "还记得吗";
